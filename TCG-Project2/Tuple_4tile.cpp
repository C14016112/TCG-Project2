...
void Tuple_4tile::Update(int board[4][4],const float error){
	...
	for (int i = 0; i < 8; i++) {
		int position = board[index[i][0] / 4][index[i][0] % 4]
			+ stage_upperbound[stage] * board[index[i][1] / 4][index[i][1] % 4]
			+ stage_upperbound[stage] * stage_upperbound[stage] * board[index[i][2] / 4][index[i][2] % 4]
			+ stage_upperbound[stage] * stage_upperbound[stage] * stage_upperbound[stage] * board[index[i][3] / 4][index[i][3] % 4];
